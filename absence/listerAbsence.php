...
<body>
  ...
  <div style="width:85%;" class="main"><br />
    ...
    ?>
    <form class="example" action="" method="post" align="center">

        <input name="keyword" type="text" class="inpp" Maxlength="20" placeholder="Classe,Nom,prenom">
        <input type="submit" name="btn" value="lister" class="right-btn"> 
        ...
        ?>
          <tr>
            ...
            <td>
              ...
              <a href="modifier_supprimer.php?delete=<?php echo $row->CODE_ABSENCE; ?>"onclick="return confirm('Etes vous sûre de vouloir supprimer cet absence ?');"><i class="material-icons" style="font-size:18px;color:red">delete</i></a>
            </td>
