...
<table class="t01">
   ...
   <?php
        ...
        $sql=("SELECT DISTINCT professeur.CIN_PROF,professeur.ID_PROF,professeur.NOM_PROF,professeur.PRENOM_PROF,professeur.TEL_PROF,professeur.EMAIL_PROF,professeur.SPECIALITE FROM professeur WHERE (professeur.NOM_PROF LIKE '$keyword'  or professeur.PRENOM_PROF LIKE '$keyword'or professeur.SPECIALITE LIKE '$keyword')");
      ...
      <?php  while($row=$result->fetch_assoc()) {  ?>
          <tr>
             ...
             <td>
               ...
               <a href="modifier-supprimer/suprimer.php?delete=<?php echo $row['ID_PROF'];?>" onclick="return confirm('Etes vous sûre de vouloir supprimer ce professeur ?');" ><i class="material-icons" style="font-size:18px;color:red">delete</i></a>
            </td>
