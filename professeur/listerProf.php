...
<table class="t01">
   ...
   <?php
        ...
        $sql=("SELECT  professeur.ID_PROF,professeur.NOM_PROF,professeur.PRENOM_PROF,professeur.TEL_PROF,professeur.EMAIL_PROF,professeur.SPECIALITE,CLASSE FROM professeur,coordonner,classe WHERE classe.CLASSE LIKE '$keyword'  AND coordonner.ID_CLASSE=classe.ID_CLASSE AND professeur.ID_PROF=coordonner.ID_PROF");       
