...
session_start();
      require('../../config.php');
        ...
        if(isset($_POST['modifier'])){
          ...
          $sql="UPDATE etudiant SET CIN='$cin',CNE='$cne',NOM_ETUD='$nom',PRENOM_ETUD='$prn',DATE_NAISS='$nais',LIEU_NAISS='$li',TEL_ETUD='$tl',EMAIL_ETUD='$el',ID_CLASSE='$cl' WHERE CNE='$cne'";
...
<body>
	<form>
            ...
            <?php endwhile;?> 
				...
				<h2><a href="../searchEtudiant.php">Retour au recherche</a></h2>
