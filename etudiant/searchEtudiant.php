...
<table class="t01">
   ...
   <?php
        ...
        $sql=("SELECT ID_ETUD,CIN,CNE,CLASSE,PRENOM_ETUD,NOM_ETUD,DATE_NAISS,LIEU_NAISS,TEL_ETUD,EMAIL_ETUD FROM etudiant INNER JOIN classe ON etudiant.ID_CLASSE=classe.ID_CLASSE WHERE CIN LIKE '$keyword' or CNE LIKE '$keyword' or NOM_ETUD LIKE '$keyword' or PRENOM_ETUD LIKE '$keyword' ");
